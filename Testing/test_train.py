...
import gym
from test_env import RopeKnotEnv
...
if __name__ == "__main__":
    ...
    default_config = {
        ...
        "render"            : True,
        "action_repeat"     : 1,
        "use_cached_states" : False,#not args.use_new,
        "save_cached_states": False,#args.save_states,
        "deterministic"     : False,
        ...
        "num_variations"    : 1,#args.num_variations,
        "observation_mode"  : "cam_rgb",
        "action_mode"       : "picker_trajectory",
        "num_picker"        : 1,
        "goal_threshold"    : 0.4,
        # "trajectory_funcs"  : [box_trajectory],
        "force_trivial"     : True,#args.force_trivial,
